package com.birdsh.chen.shiroconfig;
...
public class ShiroConfiguration {
	...
	public ShiroFilterFactoryBean shiroFilter(SecurityManager securityManager) {
		System.out.println("ShiroConfiguration.shir0Filter()");
	...
	/** 
     * 身份认证realm; 将我们自定义的Realm注入到SecurityManager中。
     * (这个需要自己写，账号密码校验；权限等) 
     * @return 
     */  
    @Bean  
